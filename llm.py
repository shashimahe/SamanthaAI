...
class Agent:
    ...
    def __init__(self, instructions, response_format):
        self.response_format = response_format
        self.llm_model = Model(response_format)  # Ensure this class is implemented and functional
        self.instructions = instructions # Load the instructions saved in a markdown file
